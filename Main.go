...
var errorDict = map[int]string{
	1: "Нераспознанные символы. Используйте только арабские/римские цифры и математические операторы '+', '-', '/', '*' ",
	2: "Некорректный ввод. Используйте только арабские или только римские цифры ",
	3: "Неверное количество аргументов. Для работы калькулятора необходимо два числа и математический оператор",
	4: "Делить на ноль нельзя! (Можно, но осторожно)",
	5: "Невозможное возможно",
	6: "Введите два числа и один математический оператор",
	7: "Некорректный ввод. В римской системе нет отрицательных чисел",
	8: "Введите числа от 0 до 10 включительно",
}
